    ...
    func draw(_ time: BarBeatTime) {
      ...
      switch self {
        ...
        case .bar:
          ...
          characters = String(time.bar + 1, radix: 10, pad: 3).characters
        ...
        case .beat:
          ...
          characters = String(time.beat + 1).characters
        ...
        case .subbeat:
          ...
          characters = String(time.subbeat + 1, radix: 10, pad: 3).characters
