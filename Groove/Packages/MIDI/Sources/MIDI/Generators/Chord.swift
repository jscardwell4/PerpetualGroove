...
public struct Chord: RawRepresentable, Hashable, CustomStringConvertible
{
  ...
  public init(root: Note = .natural(.c), pattern: Pattern = Pattern(.major))
  {
  ...
  public struct Pattern: RawRepresentable, Hashable
  {
    ...
    public init(bass: Degree? = nil, components: [Degree])
    {
