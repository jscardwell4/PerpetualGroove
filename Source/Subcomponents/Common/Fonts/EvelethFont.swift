...
public struct EvelethFont
{
  ...
  private init(_ family: Family, _ weight: Weight)
  {
    self.family = family
    self.weight = weight
  }
  ...
  public static let light = EvelethFont(.unspecified, .light)

  /// `EvelethFont` instance for "Yellow Design Studio - Eveleth Regular Bold.otf"
  public static let regularBold = EvelethFont(.unspecified, .regularBold)

  /// `EvelethFont` instance for "Yellow Design Studio - Eveleth Regular.otf"
  public static let regular = EvelethFont(.unspecified, .regular)
  ...
  public static let thin = EvelethFont(.unspecified, .thin)
}
