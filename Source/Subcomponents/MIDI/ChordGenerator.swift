...
extension ChordGenerator: MIDIGenerator {
  ...
  public func receiveNoteOn(endPoint: MIDIEndpointRef, identifier: UInt, ticks: UInt64) throws {
    for note in midiNotes { try note.receiveNoteOn(endPoint: endPoint, identifier: identifier, ticks: ticks) }
  }

  public func receiveNoteOff(endPoint: MIDIEndpointRef, identifier: UInt, ticks: UInt64) throws {
    for note in midiNotes { try note.receiveNoteOff(endPoint: endPoint, identifier: identifier, ticks: ticks) }
  }

  public func sendNoteOn(outPort: MIDIPortRef, endPoint: MIDIEndpointRef, ticks: UInt64) throws {
    for note in midiNotes { try note.sendNoteOn(outPort: outPort, endPoint: endPoint, ticks: ticks) }
  }

  public func sendNoteOff(outPort: MIDIPortRef, endPoint: MIDIEndpointRef, ticks: UInt64) throws {
    for note in midiNotes { try note.sendNoteOff(outPort: outPort, endPoint: endPoint, ticks: ticks) }
  }
