...
public struct MIDINote {
  ...
  public static func index(for note: Note) -> Int { return normalizedNotes.firstIndex(of: normalizedNote(for: note))! }
  ...
  public var midi: UInt8 { return UInt8((octave.rawValue + 1) * 12 + MIDINote.index(for: note)) }

  public var percussionMapping: PercussionMapping? { return PercussionMapping(rawValue: midi) }
...
extension MIDINote {
  ...
  public enum PercussionMapping: UInt8 {
