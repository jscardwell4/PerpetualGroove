...
public final class Document: UIDocument, Named, NotificationDispatching
{
  ...
  public var storageLocation: Manager.StorageLocation
  {
    Manager.StorageLocation(url: fileURL)
  }
  ...
  public func rename(to newName: String)
  {
    Manager.shared.queue.async
    {
      ...
      log.info("renaming document '\(oldName)' ⟹ '\(newName)'")
      ...
      if let error = error { log.error("\(error as NSObject)") }
    }
  }
                            ...
                            completionHandler: ((Bool) -> Void)?)
  {
    ...
    log.info("(\(self.isCreating ? "saving" : "overwriting"))  '\(url.path)'")
