...
public final class DocumentsViewController: UICollectionViewController {
  ...
  fileprivate var itemWidth: CGFloat = Documents.DocumentsViewController.minimumItemWidth {
    didSet {
  ...
  private var collectionHeight: CGFloat {
    return CGFloat(itemManager.count &+ 1) * Documents.DocumentsViewController.itemHeight
  }
...
//  fileprivate let itemHeight: CGFloat = UIFont.controlFont.pointSize * 2
  ...
  public override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
    ...
    let size = CGSize(width: controller?.itemWidth ?? Documents.DocumentsViewController.minimumItemWidth,
