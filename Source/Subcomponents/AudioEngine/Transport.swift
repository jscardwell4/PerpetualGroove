...
public final class Transport: NotificationDispatching {

  /// The transport currently assigned to the sequencer.
  public static var current: Transport { return Sequencer.transport }
  ...
  public func jog(by 𝝙revolutions: Double) throws {
...
extension Notification {
  ...
  public var jogTime: BarBeatTime? { return userInfo?["jogTime"] as? BarBeatTime }

  /// The bar beat time associated with a notification posted by an instance of `Transport`.
  public var time: BarBeatTime? { return userInfo?["time"] as? BarBeatTime }
