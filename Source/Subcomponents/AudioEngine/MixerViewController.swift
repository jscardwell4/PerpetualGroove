...
public final class MixerViewController: UICollectionViewController, SecondaryContentProvider {
  ...
  @IBAction
  public func selectItem(_ sender: ImageButtonView) {
  ...
  public override func numberOfSections(in collectionView: UICollectionView) -> Int { return Section.sections.count }
...
public final class MixerAddTrackCell: UICollectionViewCell {

  /// Button whose action invokes `MixerViewController.addTrack`.
  @IBOutlet public weak var addTrackButton: ImageButtonView!
...
public class MixerCell: UICollectionViewCell {
  ...
  @IBOutlet public weak var volumeSlider: Slider!

  /// Controls panning for a connection.
  @IBOutlet public weak var panKnob: Knob!
...
public final class TrackCell: MixerCell, UITextFieldDelegate {
...
public final class MixerLayout: UICollectionViewLayout {
  ...
  public override func layoutAttributesForElements(in rect: CGRect) -> [Attributes]? {
  ...
  public override func layoutAttributesForItem(at indexPath: IndexPath) -> Attributes? {
