...
public final class Sequencer: NotificationDispatching {
...
//    logi("Sequencer initialized")
  ...
  public static private(set) weak var sequence: Sequence? {
  ...
  public static let partsPerQuarter: UInt = 480

  /// The number of beats per bar.
  public static var beatsPerBar: UInt { return UInt(timeSignature.beatsPerBar) }

  /// An enumeration of the possible roles for which a transport may be assigned to the sequencer.
  public enum TransportAssignment: Equatable {
    ...
    public static func == (lhs: TransportAssignment, rhs: TransportAssignment) -> Bool {
      switch (lhs, rhs) {
  ...
  public static let primaryTransport: TransportAssignment = .primary(Transport(name: "primary"))

  /// An additional transport made available by the sequencer.
  public static let auxiliaryTransport: TransportAssignment = .auxiliary(Transport(name: "auxiliary"))
  ...
  public static var transport: Transport { return transportAssignment.transport }
  ...
  public static var tempo: Double {
    get { return transport.tempo }
    set { set(tempo: newValue) }
  }

  /// The number of beats per minute.
  public static var beatsPerMinute: UInt = 120 { didSet { tempo = Double(beatsPerMinute) } }
  ...
  public static func set(tempo: Double, automated: Bool = false) {
  ...
  public static var timeSignature: TimeSignature = .fourFour {
  ...
  public static var mode: Mode = .default {
  ...
  static public private(set) var soundFonts: [SoundFont2] = [
  ...
  static public private(set) var auditionInstrument: Instrument!
