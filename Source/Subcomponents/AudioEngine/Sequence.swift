...
public final class Sequence: /*Nameable,*/ NotificationDispatching, CustomStringConvertible {
...
//  }
  ...
  public static var current: Sequence? { return Sequencer.sequence }

  /// The time of the last event in the sequence.
  public var sequenceEnd: BarBeatTime {
...
//          newTrack.recording = true
  ...
  public private(set) var tempoTrack: TempoTrack!
...
//  public private(set) weak var document: Document!
  ...
  /// sequence's document.
//  public var name: String? { return document?.localizedName }
...
extension Notification {
  ...
  public var removedTrackIndex: Int? { return userInfo?["removedTrackIndex"] as? Int }
  ...
  /// by a sequence.
  public var addedTrackIndex: Int? { return userInfo?["addedTrackIndex"] as? Int }
  ...
  public var removedTrack: InstrumentTrack? { return userInfo?["removedTrack"] as? InstrumentTrack }
