...
public final class AudioEngine {
  ...
  public static var mixer: AVAudioMixerNode { return engine.mainMixerNode }

  /// The collection of instruments for which a node has been connected to the mixer.
  static public private(set) var instruments: [Instrument] = []

  /// The `Metronome` instance attached to the mixer.
  static public private(set) var metronome: Metronome!
  ...
  public static func attach(node: AVAudioNode, for instrument: Instrument) {
  ...
  public static var running: Bool { return engine.isRunning }
