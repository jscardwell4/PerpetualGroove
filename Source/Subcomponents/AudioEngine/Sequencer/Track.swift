...
public class Track: Named, MIDIEventDispatch, CustomStringConvertible {
  ...
  public var chunk: TrackChunk {
    ...
    let events: [MIDIEvent] = headEvents + [MIDIEvent](eventContainer) + tailEvents
  ...
  public func add<S: Swift.Sequence>(events: S) where S.Element == MIDIEvent {
