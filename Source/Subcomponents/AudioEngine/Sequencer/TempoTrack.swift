...
public final class TempoTrack: Track {
  ...
  public var tempo: Double = Sequencer.shared.tempo {
    didSet {
  ...
  public var timeSignature: TimeSignature = Sequencer.shared.timeSignature {
    didSet {
  ...
  private var tempoEvent: MetaEvent {
    ...
    let time = Sequencer.shared.time.barBeatTime
