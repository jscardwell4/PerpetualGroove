...
public final class TempoTrack: Track {
  ...
  public var tempo: Double = Controller.shared.tempo {
    didSet {
  ...
  public var timeSignature: TimeSignature = Controller.shared.timeSignature {
    didSet {
  ...
  private var tempoEvent: MetaEvent {
    ...
    let time = Controller.shared.time.barBeatTime
