...
public final class NodeManager {
  ...
  public func stopNodes(remove: Bool = false) {
    ...
    log.info("nodes stopped\(remove ? " and removed" : "")")
  }
  ...
  public func add(node: Node) throws {
    ...
    log.info("adding node \(node.name!) (\(node.identifier))")
  }
  ...
  public func handle(event: NodeEvent) {
    switch event.data {
      ...
      case let .remove(eventIdentifier):
        ...
        log.info("removing node with identifier \(identifier)")
  ...
  private func remove(node: Node, delete: Bool) throws {
    ...
    log.info("removing node \(node.name!) \(node.identifier)")
