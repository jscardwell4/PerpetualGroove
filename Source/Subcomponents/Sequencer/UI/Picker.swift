...
public class Picker: UIControl, InlinePickerDelegate {
  ...
  public func numberOfItems(in _: InlinePickerView) -> Int {
    items.count
  }

  /// Returns the element in `items` at `item`.
  public func inlinePicker(_: InlinePickerView,
...
public final class SoundFontSelector: Picker {
  ...
  override class var contentForInterfaceBuilder: [InlinePickerView.Item] { labels }
}
...
public final class ProgramSelector: Picker {
...
/// Subclass of `Picker` whose selectable items are the 'flat', 'natural', and 'sharp'
/// pitch modifiers.
public final class PitchModifierSelector: Picker {
  ...
  private static let images: [InlinePickerView.Item] = {
      ...
      return ["flat", "natural", "sharp"].flatMap {
        [bundle = Bundle(_: DurationSelector.self)] in

        guard let image = UIImage(named: $0, in: bundle, compatibleWith: nil) else {
          return nil
        }
  ...
  override class var initialSelection: Int { 1 }

  /// Overridden to return `images`.
  override class var contentForInterfaceBuilder: [InlinePickerView.Item] { images }
  ...
  override fileprivate func setMetrics(for picker: InlinePickerView) {
    picker.itemHeight = 28
    picker.itemPadding = 8
  }

  /// Overridden to adjust the vertical offset by `-1`.
  override public func inlinePicker(_: InlinePickerView,
                                    contentOffsetForItem _: Int) -> UIOffset
  {
...
public final class ChordSelector: Picker {
  ...
  /// Overridden to return `labels`.
  override class var contentForInterfaceBuilder: [InlinePickerView.Item] {
...
public final class OctaveSelector: Picker {
  ...
  override class var initialSelection: Int { 5 }
...
public final class VelocitySelector: Picker {
  ...
  override class var initialSelection: Int { 4 }
