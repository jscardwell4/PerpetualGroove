...
public final class MIDINodePlayerContainer: SecondaryControllerContainer {

  /// The primary controller.
  public private(set) weak var playerViewController: MIDINodePlayerViewController! {
  ...
  public override var blurFrame: CGRect {
