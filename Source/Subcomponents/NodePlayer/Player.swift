...
/// Singleton for coordinating `Node` and `PlayerNode` operations.
public final class Player: NotificationDispatching {
  ...
  public static weak var currentDispatch: NodeDispatch? {
    willSet {
  ...
  /// Updates the value of `currentDispatch` according to the state of tracks, loops,
  /// and sequencer mode.
...
//          NodePlayer.loops[ObjectIdentifier(track)] = nil
//          NodePlayer.updateCurrentDispatch()
//        }
//        receptionist.observe(name: .didChangeTrack, from: sequence) {
//          _ in NodePlayer.updateCurrentDispatch()
//        }
//      }
...
//    loopEnd = .zero
  ...
  public static weak var playerContainer: Container?
  ...
  public static weak var playerNode: PlayerNode? {
    didSet {
...
//  static private var loops: [ObjectIdentifier:Loop] = [:]
  ...
  /// Creates a new `Node` object using the specified parameters and adds it to `playerNode`.
  public static func placeNew(_ trajectory: Node.Trajectory,
                       target: NodeDispatch,
...
//    }
  ...
  public static func remove(node: Node) {
...
extension Notification {
  ...
  public var addedNode: Node? { return userInfo?["addedNode"] as? Node }

  public var addedNodeDispatch: NodeDispatch? { return userInfo?["addedNodeDispatch"] as? NodeDispatch }
