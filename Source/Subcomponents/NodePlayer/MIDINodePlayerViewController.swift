...
public final class MIDINodePlayerViewController: UIViewController, UITextFieldDelegate {
...
//                         callback: weakCapture(of: self, block:MIDINodePlayerViewController.didExitLoopMode))
  ...
  @IBOutlet public weak var documentName: UITextField!

  /// Spinner for indicating the opening of a file.
  @IBOutlet public weak var spinner: UIImageView! {
  ...
  @IBOutlet public weak var playerView: MIDINodePlayerView!
