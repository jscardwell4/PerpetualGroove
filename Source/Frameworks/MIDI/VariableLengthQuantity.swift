...
public struct VariableLengthQuantity: CustomStringConvertible/*, CustomDebugStringConvertible*/ {
  ...
  public init<S:Swift.Sequence>(bytes b: S) where S.Iterator.Element == UInt8 { bytes = Array(b) }
...
extension UInt64 {
  ...
  public init(_ quantity: VariableLengthQuantity) {
