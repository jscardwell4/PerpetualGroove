...
public final class MIDIClock: CustomStringConvertible, Named {
...
//  static var current: MIDIClock { return Transport.current.clock }
  ...
  public var isPaused: Bool { return !isRunning && ticks > 0 }
  ...
  public var isRunning: Bool { return timer.running }
