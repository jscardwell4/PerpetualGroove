...
enum Note: RawRepresentable, Comparable, Hashable {
  ...
  /// The note's hash value. To be consistent with note equality, the hash values are
  /// derived from the note's normalized form.
  var hashValue: Int {

    return normalized.rawValue.hashValue
