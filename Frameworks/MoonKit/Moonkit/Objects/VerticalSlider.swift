...
//  public override class func requiresConstraintBasedLayout() -> Bool { return true }
  ...
  */
  ...
  @IBInspectable public var minimumValueImage: UIImage? { get { return slider.minimumValueImage } set { slider.minimumValueImage = newValue } }
  @IBInspectable public var maximumValueImage: UIImage? { get { return slider.maximumValueImage } set { slider.maximumValueImage = newValue } }

  @IBInspectable public var continuous: Bool { get { return slider.continuous } set { slider.continuous = newValue } }

  @available(iOS 5.0, *)
  @IBInspectable public var minimumTrackTintColor: UIColor? { get { return slider.minimumTrackTintColor } set { slider.minimumTrackTintColor = newValue } }
  @available(iOS 5.0, *)
  @IBInspectable public var maximumTrackTintColor: UIColor? { get { return slider.maximumTrackTintColor } set { slider.maximumTrackTintColor = newValue } }
  @available(iOS 5.0, *)
  @IBInspectable public var thumbTintColor: UIColor? { get { return slider.thumbTintColor } set { slider.thumbTintColor = newValue } }
