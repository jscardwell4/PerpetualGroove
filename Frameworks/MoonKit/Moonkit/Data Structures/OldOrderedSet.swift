...
public struct OldOrderedSet<Element:Equatable> : MutableCollectionType {
  ...
  */
  ...
  public typealias SubSlice = OldOrderedSet<Element>
  ...
  */
  public subscript (subRange: Range<Int>) -> OldOrderedSet<Element> {
    get { return OldOrderedSet(storage[subRange]) }
  ...
  */
  ...
  - returns: [Element]
  */
  public func sorted(isOrderedBefore: (Element, Element) -> Bool) -> OldOrderedSet<Element> { return OldOrderedSet(storage.sort(isOrderedBefore)) }
  ...
  - returns: [U]
  */
  public func map<U: Equatable>(transform: (Element) -> U) -> OldOrderedSet<U> { return OldOrderedSet<U>(storage.map(transform)) }
  ...
  - returns: [Element]
  */
  public func reverse() -> OldOrderedSet<Element> { return OldOrderedSet(Array(storage.reverse())) }
  ...
  - returns: [Element]
  */
  public func filter(includeElement: (Element) -> Bool) -> OldOrderedSet<Element> { return OldOrderedSet<Element>(storage.filter(includeElement)) }
  ...
  */
  ...
  /**
  Return a new `OldOrderedSet` with items in both this set and a finite sequence.

  - parameter sequence: S

  - returns: OldOrderedSet<Element>
  */
  public func union<S:SequenceType where S.Generator.Element == Element>(sequence: S) -> OldOrderedSet<Element> {
  ...
  */
  ...
  - returns: OldOrderedSet<Element>
  */
  public func subtract<S:SequenceType where S.Generator.Element == Element>(sequence: S) -> OldOrderedSet<Element> {
  ...
  */
  ...
  - returns: OldOrderedSet<Element>
  */
  public func intersect<S:SequenceType where S.Generator.Element == Element>(sequence: S) -> OldOrderedSet<Element> {
  ...
  */
  ...
  - returns: OldOrderedSet<Element>
  */
  public func exclusiveOr<S:SequenceType where S.Generator.Element == Element>(sequence: S) -> OldOrderedSet<Element> {
  ...
  */
  public mutating func exclusiveOrInPlace<S:SequenceType where S.Generator.Element == Element>(sequence: S) {
    intersectInPlace(subtract(sequence).union(OldOrderedSet(sequence).subtract(self)))
  }
...
extension OldOrderedSet : ArrayLiteralConvertible {
...
extension OldOrderedSet : CustomStringConvertible, CustomDebugStringConvertible {
...
extension OldOrderedSet: _ObjectiveCBridgeable {
  ...
  static public func _forceBridgeFromObjectiveC(source: NSOrderedSet, inout result: OldOrderedSet?) {
    var s = OldOrderedSet()
    for o in source {
  ...
  static public func _conditionallyBridgeFromObjectiveC(source: NSOrderedSet, inout result: OldOrderedSet?) -> Bool {
    var s = OldOrderedSet()
    for o in source {
      if let object = typeCast(o, Element.self) { s.append(object) }
    }
...
// MARK: - Equatable
extension OldOrderedSet : Equatable {}

/**
subscript:rhs:

- parameter lhs: OldOrderedSet<T>
- parameter rhs: OldOrderedSet<T>

- returns: Bool
*/
public func ==<T>(lhs: OldOrderedSet<T>, rhs: OldOrderedSet<T>) -> Bool { return lhs.storage == rhs.storage }
...
- returns: OldOrderedSet<T>
*/
public func +<T:Equatable, S:SequenceType where S.Generator.Element == T>(lhs: OldOrderedSet<T>, rhs: S) -> OldOrderedSet<T> {
...
- parameter rhs: S
*/
public func +=<T:Equatable, S:SequenceType where S.Generator.Element == T>(inout lhs: OldOrderedSet<T>, rhs: S) {
...
- returns: Bool
*/
public func ⊆<T:Equatable, S:SequenceType where S.Generator.Element == T>(lhs: OldOrderedSet<T>, rhs: S) -> Bool {
...
- returns: Bool
*/
public func ∈<T:Equatable>(lhs: T, rhs: OldOrderedSet<T>) -> Bool { return rhs.contains(lhs) == true }
...
- returns: Bool
*/
public func ∈<T:Equatable>(lhs: T?, rhs: OldOrderedSet<T>) -> Bool { return lhs != nil && rhs.contains(lhs!) == true }
...
- returns: Bool
*/
public func ∋<T:Equatable>(lhs: OldOrderedSet<T>, rhs: T) -> Bool { return lhs.contains(rhs) == true }
...
- returns: Bool
*/
public func ∉<T:Equatable>(lhs: T, rhs: OldOrderedSet<T>) -> Bool { return rhs.contains(lhs) == false }
...
- returns: Bool
*/
public func ∌<T:Equatable>(lhs: OldOrderedSet<T>, rhs: T) -> Bool { return lhs.contains(rhs) == false }

// MARK: - NestingContainer
extension OldOrderedSet: NestingContainer {
...
// MARK: - KeySearchable
extension OldOrderedSet: KeySearchable {
